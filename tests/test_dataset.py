...
def test_spoken_squad_loading():
    ...
    try:
        ...
        print(f"  Dataset name: spoken_squad")
        print(f"  Split: train")
        ...
        print("\nPossible issues:")
        print("1. Dataset 'spoken_squad' might not be available on HuggingFace")
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("\nNote: If the dataset name 'spoken_squad' doesn't exist,")
